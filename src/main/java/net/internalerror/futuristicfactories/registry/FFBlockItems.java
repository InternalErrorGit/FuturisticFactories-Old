...
public class FFBlockItems {
  ...
  public static final RegistryObject<Item> pulverizing_machine = register("pulverizing_machine", () -> new BlockItem(FFBlocks.pulverizing_machine.get(), new Item.Properties().tab(FFTabs.MACHINES)));
