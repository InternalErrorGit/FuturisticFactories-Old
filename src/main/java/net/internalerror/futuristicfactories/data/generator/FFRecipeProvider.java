...
public class FFRecipeProvider extends RecipeProvider {
  ...
  private static final class Util {
    ...
    public static void crushing(Consumer<FinishedRecipe> consumer, TagKey<Item> ingredientTag, RegistryObject<Item> ingredient, RegistryObject<Item> result, int resultCount) {
